...
color: "black"
    ...
    ScrollView {
        ...
        Text {
            ...
            wrapMode: Text.WordWrap
            color: "white"
            text: "«Берсерк» — российская коллекционная карточная игра, «Мир Хобби» с 2003 года. В октябре 2015 года классическая версия была заморожена, однако 6 ноября 2015 года вышло ответвление «Берсерк. Герои». В 2023 году классическая версия была перезапущена с новым дизайном карт. Авторы Берсерка — Иван Попов и Максим Истомин.
